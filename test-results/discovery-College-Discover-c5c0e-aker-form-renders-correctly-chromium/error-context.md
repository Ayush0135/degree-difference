...
- Name: discovery.spec.ts >> College Discovery Flow >> AI Matchmaker form renders correctly
- Location: tests/discovery.spec.ts:18:3
...
Locator: locator('h1:has-text("AI College Matchmaker")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1:has-text("AI College Matchmaker")')
